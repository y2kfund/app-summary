...
var zn = (i, t, e) => t in i ? Fn(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var T = (i, t, e) => zn(i, typeof t != "symbol" ? t + "" : t, e);
import { inject as js, defineComponent as mi, shallowRef as $s, h as ii, ref as Pe, onMounted as Us, onUnmounted as Rn, watch as En, toRaw as si, nextTick as Hn, version as Bn, isProxy as Ys, reactive as Li, computed as ot, onBeforeUnmount as Nn, resolveComponent as Wn, createElementBlock as q, openBlock as G, createCommentVNode as ge, unref as Rt, createElementVNode as y, toDisplayString as N, createBlock as Vn, withCtx as jn, createTextVNode as $n, Fragment as Un, renderList as Yn, normalizeClass as Ye, createVNode as Gn } from "vue";
...
const vt = (i, t, e) => Math.max(Math.min(i, e), t);
function Kt(i) {
  return vt(fe(i * 2.55), 0, 255);
}
function wt(i) {
  return vt(fe(i * 255), 0, 255);
}
function mt(i) {
  return vt(fe(i / 2.55) / 100, 0, 1);
}
function Ii(i) {
  return vt(fe(i * 100), 0, 100);
}
...
function _i(i, t, e, s) {
  return (Array.isArray(t) ? i(t[0], t[1], t[2]) : i(t, e, s)).map(wt);
}
function xi(i, t, e) {
  return _i(Gs, i, t, e);
}
...
function po() {
  const i = {}, t = Object.keys(zi), e = Object.keys(Fi);
  let s, n, o, r, a;
...
function _o(i) {
  ...
  if (t) {
    if (t[7] !== s) {
      const r = +t[7];
      e = t[8] ? Kt(r) : vt(r * 255, 0, 255);
    }
    return s = +t[1], n = +t[3], o = +t[5], s = 255 & (t[2] ? Kt(s) : vt(s, 0, 255)), n = 255 & (t[4] ? Kt(n) : vt(n, 0, 255)), o = 255 & (t[6] ? Kt(o) : vt(o, 0, 255)), {
      r: s,
      g: n,
      b: o,
      a: e
...
const Ge = (i) => i <= 31308e-7 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055, Et = (i) => i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4);
function yo(i, t, e) {
  const s = Et(mt(i.r)), n = Et(mt(i.g)), o = Et(mt(i.b));
  return {
    r: wt(Ge(s + e * (Et(mt(t.r)) - s))),
    g: wt(Ge(n + e * (Et(mt(t.g)) - n))),
    b: wt(Ge(o + e * (Et(mt(t.b)) - o))),
    a: i.a + e * (t.a - i.a)
  };
}
function be(i, t, e) {
...
function Ri(i) {
  ...
  return Array.isArray(i) ? i.length >= 3 && (t = { r: i[0], g: i[1], b: i[2], a: 255 }, i.length > 3 && (t.a = wt(i[3]))) : (t = Xs(i, { r: 0, g: 0, b: 0, a: 1 }), t.a = wt(t.a)), t;
}
function vo(i) {
...
class ae {
  constructor(t) {
    ...
    const e = typeof t;
    let s;
    e === "object" ? s = Ri(t) : e === "string" && (s = io(t) || mo(t) || vo(t)), this._rgb = s, this._valid = !!s;
  }
  get valid() {
    return this._valid;
  }
...
function Mo(i, t, e) {
  if (!Ks(i))
    return;
  const s = t[i], n = e[i];
  z(s) && z(n) ? ee(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = ze(n));
}
const Ei = {
...
const Ee = (i) => typeof i < "u", kt = (i) => typeof i == "function", Hi = (i, t) => {
  if (i.size !== t.size)
    return !1;
  for (const e of i)
    if (!t.has(e))
...
const $ = Math.PI, ct = 2 * $, Po = ct + $, He = Number.POSITIVE_INFINITY, To = $ / 180, st = $ / 2, Ct = $ / 4, Bi = $ * 2 / 3, Qs = Math.log10, Nt = Math.sign;
function ie(i, t, e) {
...
function Zs(i, t, e, s) {
  const n = yt(i), o = yt(t), r = yt(e), a = yt(o - n), l = yt(r - n), c = yt(n - o), h = yt(n - r);
  ...
  if (i._sorted) {
    ...
    if (f) {
      if (n = Math.min(
        ...
        const p = l.slice(0, n + 1).reverse().findIndex((m) => !H(m[a.axis]));
        n -= Math.max(0, p);
      }
      n = J(n, 0, s - 1);
    }
    if (g) {
      let p = Math.max(
        // @ts-expect-error Need to type _parsed
        Lt(l, r.axis, u, !0).hi + 1,
        // @ts-expect-error Need to fix types on _lookupByKey
        e ? 0 : Lt(t, h, r.getPixelForValue(u), !0).hi + 1
      );
      if (c) {
        const m = l.slice(p - 1).findIndex((_) => !H(_[a.axis]));
        p += Math.max(0, m);
      }
      o = J(p, n, s) - n;
    } else
...
const _e = (i) => i === 0 || i === 1, ji = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * ct / e)), $i = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * ct / e) + 1, se = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
...
const Ft = /* @__PURE__ */ Object.create(null), ai = /* @__PURE__ */ Object.create(null);
function ne(i, t) {
  if (!t)
    return i;
  const e = t.split(".");
    ...
    Object.defineProperties(o, {
      ...
      [e]: {
        ...
        get() {
          ...
          return z(l) ? Object.assign({}, c, l) : L(l, c);
        },
        set(l) {
          this[a] = l;
        }
...
function on(i, t, e, s, n) {
  ...
  if (!(isNaN(p) || p <= 0)) {
    switch (i.beginPath(), f) {
      default:
        n ? i.ellipse(e, s, n / 2, p, 0, 0, ct) : i.arc(e, s, p, 0, ct), i.closePath();
        break;
      case "triangle":
        h = n ? n / 2 : p, i.moveTo(e + Math.sin(m) * h, s - Math.cos(m) * p), m += Bi, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * p), m += Bi, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * p), i.closePath();
        break;
      case "rectRounded":
        c = p * 0.516, l = p - c, r = Math.cos(m + Ct) * l, d = Math.cos(m + Ct) * (n ? n / 2 - c : l), a = Math.sin(m + Ct) * l, u = Math.sin(m + Ct) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - $, m - st), i.arc(e + u, s - r, c, m - st, m), i.arc(e + d, s + a, c, m, m + st), i.arc(e - u, s + r, c, m + st, m + $), i.closePath();
        break;
      case "rect":
        if (!g) {
...
function de(i, t, e, s, n, o = {}) {
  ...
  let l, c;
  for (i.save(), i.font = n.string, or(i, o), l = 0; l < r.length; ++l)
    c = r[l], o.backdrop && ar(i, o.backdrop), a && (o.strokeColor && (i.strokeStyle = o.strokeColor), H(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), rr(i, e, s, c, o), s += Number(n.lineHeight);
  i.restore();
}
function ci(i, t) {
  const { x: e, y: s, w: n, h: o, radius: r } = t;
  i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * $, $, !0), i.lineTo(e, s + o - r.bottomLeft), i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, $, st, !0), i.lineTo(e + n - r.bottomRight, s + o), i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, st, 0, !0), i.lineTo(e + n, s + r.topRight), i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -st, !0), i.lineTo(e + r.topLeft, s);
}
const lr = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, cr = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function hr(i, t) {
  const e = ("" + i).match(lr);
  if (!e || e[1] === "normal")
    return t * 1.2;
...
const dr = (i) => +i || 0;
function rn(i, t) {
  const e = {}, s = z(t), n = s ? Object.keys(t) : t, o = z(i) ? s ? (r) => L(i[r], i[t[r]]) : (r) => i[r] : () => i;
  for (const r of n)
    e[r] = dr(o(r));
  return e;
}
...
function Y(i, t) {
  ...
  s && !("" + s).match(cr) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
  const n = {
    family: L(i.family, t.family),
    lineHeight: hr(L(i.lineHeight, t.lineHeight), e),
    size: e,
    style: s,
    weight: L(i.weight, t.weight),
    string: ""
  };
  return n.string = ir(n), n;
}
function xe(i, t, e, s) {
  let n, o, r;
...
function fr(i, t, e) {
  const { min: s, max: n } = i, o = ko(t, (n - s) / 2), r = (a, l) => e && a === 0 ? 0 : a + l;
  return {
    min: r(s, -Math.abs(o)),
    max: r(n, o)
  };
...
const gr = (i, t) => i ? i + yi(t) : t, Di = (i, t) => z(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function ln(i, t, e) {
...
function pr(i, t, e) {
  ...
  let a = s[t];
  return kt(a) && r.isScriptable(t) && (a = mr(t, a, i, e)), j(a) && a.length && (a = br(t, a, i, r.isIndexable)), Di(t, a) && (a = Wt(a, n, o && o[t], r)), a;
}
function mr(i, t, e, s) {
...
const _r = (i, t) => i === !0 ? t : typeof i == "string" ? Re(t, i) : void 0;
...
function Ki(i) {
  let t = i._keys;
  return t || (t = i._keys = wr(i._scopes)), t;
}
function wr(i) {
...
const kr = Number.EPSILON || 1e-14, Vt = (i, t) => t < i.length && !i[t].skip && i[t], dn = (i) => i === "x" ? "y" : "x";
function Sr(i, t, e, s) {
...
function Pr(i, t, e, s, n) {
  ...
  if (t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone")
    ...
    for (o = 0, r = i.length; o < r; ++o)
      a = i[o], l = Sr(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a;
  }
...
const Lr = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function Ir(i, t) {
...
function Pt(i, t) {
  if ("native" in i)
    return i;
  const { canvas: e, currentDevicePixelRatio: s } = t, n = Ve(e), o = n.boxSizing === "border-box", r = It(n, "padding"), a = It(n, "border", "width"), { x: l, y: c, box: h } = Ir(i, e), d = r.left + (h && a.left), u = r.top + (h && a.top);
...
function Fr(i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o)
      ...
      const r = o.getBoundingClientRect(), a = Ve(o), l = It(a, "border", "width"), c = It(a, "padding");
...
function zr(i, t, e, s) {
  const n = Ve(i), o = It(n, "margin"), r = Be(n.maxWidth, i, "clientWidth") || He, a = Be(n.maxHeight, i, "clientHeight") || He, l = Fr(i, t, e);
...
function Zi(i, t) {
  const e = Tr(i, t), s = e && e.match(/^(\d+)(\.\d+)?px$/);
  return s ? +s[1] : void 0;
}
function Tt(i, t, e, s) {
  return {
...
function Vr(i, t, e) {
  ...
  const { property: s, start: n, end: o } = e, r = t.length, { compare: a, between: l, normalize: c } = gn(s), { start: h, end: d, loop: u, style: f } = Wr(i, t, e), g = [];
  let p = !1, m = null, _, S, C;
  const w = () => l(n, C, _) && a(n, C) !== 0, v = () => a(o, _) === 0 || l(o, C, _), D = () => p || w(), O = () => !p || v();
  for (let M = h, P = h; M <= d; ++M)
    S = t[M % r], !S.skip && (_ = c(S[s]), _ !== C && (p = l(_, n, o), m === null && D() && (m = a(_, n) === 0 ? M : P), m !== null && O() && (g.push(Ji({
      start: m,
      end: M,
      loop: u,
      count: r,
...
function Yr(i, t) {
  ...
  if (!n)
    return [];
  const o = !!i._loop, { start: r, end: a } = $r(e, n, o, s);
  if (s === !0)
    return ts(i, [
      {
        start: r,
  ...
  for (const g of t) {
    ...
    for (u = d + 1; u <= g.end; u++) {
      ...
      m = es(s.setContext(zt(n, {
        ...
        p1DataIndex: u % l,
        datasetIndex: r
      }))), qr(m, h) && f(d, u - 1, g.loop, h), p = _, h = m;
    }
...
var gt = /* @__PURE__ */ new Qr();
const is = "transparent", Zr = {
  boolean(i, t, e) {
    return e > 0.5 ? t : i;
  },
  color(i, t, e) {
...
class Jr {
  constructor(t, e, s, n) {
    ...
    this._active = !0, this._fn = t.fn || Zr[t.type || typeof r], this._easing = se[t.easing] || se.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = s, this._from = r, this._to = n, this._promises = void 0;
  }
  active() {
    return this._active;
  }
...
function ns(i, t, e, s = {}) {
  ...
  for (r = 0, a = n.length; r < a; ++r) {
    ...
    c = i.values[l], et(c) && (o || t === 0 || Nt(t) === Nt(c)) && (t += c);
  }
  return !h && !s.all ? 0 : t;
}
function na(i, t) {
...
function rs(i, t) {
  ...
  for (let f = 0; f < d; ++f) {
    ...
    u = _[c] = aa(n, h, p), u[a] = m, u._top = os(u, r, !0, s.type), u._bottom = os(u, r, !1, s.type);
    const S = u._visualValues || (u._visualValues = {});
    S[a] = m;
  }
}
function Qe(i, t) {
...
const Ze = (i) => i === "reset" || i === "none", as = (i, t) => t ? i : Object.assign({}, i), ha = (i, t, e) => i && !t.hidden && t._stacked && {
  keys: mn(e, !0),
  values: null
};
class re {
  ...
  linkScales() {
    const t = this.chart, e = this._cachedMeta, s = this.getDataset(), n = (d, u, f, g) => d === "x" ? u : d === "r" ? g : f, o = e.xAxisID = L(s.xAxisID, Qe(t, "x")), r = e.yAxisID = L(s.yAxisID, Qe(t, "y")), a = e.rAxisID = L(s.rAxisID, Qe(t, "r")), l = e.indexAxis, c = e.iAxisID = n(l, o, r, a), h = e.vAxisID = n(l, r, o, a);
  ...
  parse(t, e) {
    ...
    if (this._parsing === !1)
      ...
      j(n[t]) ? u = this.parseArrayData(s, n, t, e) : z(n[t]) ? u = this.parseObjectData(s, n, t, e) : u = this.parsePrimitiveData(s, n, t, e);
  ...
  getMinMax(t, e) {
    const s = this._cachedMeta, n = s._parsed, o = s._sorted && t === s.iScale, r = n.length, a = this._getOtherScale(t), l = ha(e, s, this.chart), c = {
  ...
  _update(t) {
    const e = this._cachedMeta;
    this.update(t || "default"), e._clip = sa(L(this.options.clip, ia(e.xScale, e.yScale, this.getMaxOverflow())));
  }
  update(t) {
  }
  draw() {
  ...
  getContext(t, e, s) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      o = r.$context || (r.$context = ca(this.getContext(), t, r)), o.parsed = this.getParsed(t), o.raw = n.data[t], o.index = o.dataIndex = t;
    } else
  ...
  _resolveElementOptions(t, e = "default", s) {
    ...
    return p.$shared && (p.$shared = l, o[r] = Object.freeze(as(p, l))), p;
  }
...
class Te extends re {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset", { iScale: r, vScale: a, _stacked: l, _dataset: c } = this._cachedMeta, { sharedOptions: h, includeOptions: d } = this._getSharedOptions(e, n), u = r.axis, f = a.axis, { spanGaps: g, segment: p } = this.options, m = ce(g) ? g : Number.POSITIVE_INFINITY, _ = this.chart._animationsDisabled || o || n === "none", S = e + s, C = t.length;
    ...
    for (let v = 0; v < C; ++v) {
      ...
      const M = this.getParsed(v), P = H(M[f]), I = O[u] = r.getPixelForValue(M[u], v), x = O[f] = o || P ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, M, l) : M[f], v);
      O.skip = isNaN(I) || isNaN(x) || P, O.stop = v > 0 && Math.abs(M[u] - w[u]) > m, p && (O.parsed = M, O.raw = c.data[v]), d && (O.options = h || this.resolveDataElementOptions(v, D.active ? "active" : n)), _ || this.updateElement(D, v, O, n), w = M;
    }
  }
  getMaxOverflow() {
...
function ua(i, t, e, s) {
  ...
  if (a && t === a.axis && t !== "r" && r && o.length) {
    const c = a._reversePixels ? Bo : Lt;
    if (s) {
      if (n._sharedOptions) {
...
function je(i, t, e, s, n) {
  ...
  for (let a = 0, l = o.length; a < l; ++a) {
    const { index: c, data: h } = o[a], { lo: d, hi: u } = ua(o[a], t, r, n);
    for (let f = d; f <= u; ++f) {
      const g = h[f];
      g.skip || s(g, c, f);
    }
...
function ti(i, t, e, s, n, o) {
  return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? ga(i, t, e, n) : pa(i, t, e, s, n, o);
}
...
var ma = {
  modes: {
    index(i, t, e, s) {
      const n = Pt(t, i), o = e.axis || "x", r = e.includeInvisible || !1, a = e.intersect ? Je(i, n, o, s, r) : ti(i, n, o, !1, s, r), l = [];
...
function xa(i, t) {
  const e = _a(i), { vBoxMaxWidth: s, hBoxMaxHeight: n } = t;
  let o, r, a;
  for (o = 0, r = i.length; o < r; ++o) {
    a = i[o];
...
function ya(i) {
  const t = ba(i), e = Gt(t.filter((c) => c.box.fullSize), !0), s = Gt(Yt(t, "left"), !0), n = Gt(Yt(t, "right")), o = Gt(Yt(t, "top"), !0), r = Gt(Yt(t, "bottom")), a = cs(t, "x"), l = cs(t, "y");
  return {
    fullSize: e,
...
function Zt(i, t, e, s) {
  ...
  for (o = 0, r = i.length, c = 0; o < r; ++o) {
    a = i[o], l = a.box, l.update(a.width || t.w, a.height || t.h, ka(a.horizontal, t));
    const { same: d, other: u } = va(t, e, a, s);
...
var tt = {
  ...
  update(i, t, e, s) {
    if (!i)
      return;
    const n = it(i.options.layout.padding), o = Math.max(t - n.width, 0), r = Math.max(e - n.height, 0), a = ya(i.boxes), l = a.vertical, c = a.horizontal;
    E(i.boxes, (p) => {
    ...
    Zt(a.fullSize, f, d, g), Zt(l, f, d, g), Zt(c, f, d, g) && Zt(l, f, d, g), wa(f), ds(a.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, ds(a.rightAndBottom, f, d, g), i.chartArea = {
      left: f.left,
      top: f.top,
      right: f.left + f.w,
      bottom: f.top + f.h,
...
function Pa(i, t) {
  const e = Ma[i.type] || i.type, { x: s, y: n } = Pt(i, t);
  return {
    type: e,
    chart: t,
    native: i,
...
function Fa(i, t, e) {
  ...
  return r.observe(n), La(i, o), r;
}
function ei(i, t, e) {
  e && e.disconnect(), t === "resize" && Ia(i);
}
function za(i, t, e) {
...
class Ra extends xn {
  acquireContext(t, e) {
    ...
    return s && s.canvas === t ? (Ca(t, e), s) : null;
  }
  releaseContext(t) {
    const e = t.canvas;
    if (!e[Ae])
...
function Ea(i) {
  return !Pi() || typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas ? Sa : Ra;
}
class bt {
  constructor() {
    T(this, "x");
...
T(bt, "defaults", {}), T(bt, "defaultRoutes");
function Ha(i, t) {
  const e = i.options.ticks, s = Ba(i), n = Math.min(e.maxTicksLimit || s, s), o = e.major.enabled ? Wa(t) : [], r = o.length, a = o[0], l = o[r - 1], c = [];
  if (r > n)
    return Va(t, c, o, r / n), c;
  const h = Na(o, t, n);
  if (r > 0) {
    let d, u;
    const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
    for (Se(t, c, h, H(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++)
      Se(t, c, h, o[d], o[d + 1]);
    return Se(t, c, h, l, H(f) ? t.length : l + f), c;
  }
  return Se(t, c, h), c;
}
function Ba(i) {
...
const $a = (i) => i === "left" ? "right" : i === "right" ? "left" : i, gs = (i, t, e) => t === "top" || t === "left" ? i[t] + e : i[t] - e, ps = (i, t) => Math.min(t || i, i);
function ms(i, t) {
...
function Xa(i, t, e) {
  let s = wi(i);
  return (e && t !== "right" || !e && t === "right") && (s = $a(s)), s;
}
function Ka(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (f = U(s, o, a), z(e)) {
      ...
      g = h[_].getPixelForValue(S) + p - t;
    } else e === "center" ? g = (c.bottom + c.top) / 2 + p - t : g = gs(i, e, t);
    u = a - o;
  } else {
    if (z(e)) {
      const _ = Object.keys(e)[0], S = e[_];
      f = h[_].getPixelForValue(S) - m + t;
    } else e === "center" ? f = (c.left + c.right) / 2 - m + t : f = gs(i, e, t);
    g = U(s, r, n), d = e === "left" ? -st : st;
  }
  return {
    titleX: f,
    titleY: g,
...
class jt extends bt {
  ...
  update(t, e, s) {
    ...
    this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = s = Object.assign({
      ...
      top: 0,
      bottom: 0
    }, s), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + s.left + s.right : this.height + s.top + s.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = fr(this, o, n), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
  ...
  calculateLabelRotation() {
    ...
    a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? 0.5 : 1)), l = this.maxHeight - qt(t.grid) - e.padding - bs(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = zo(Math.min(Math.asin(J((h.highest.height + 6) / a, -1, 1)), Math.asin(J(l / c, -1, 1)) - Math.asin(J(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
  }
  ...
  fit() {
    ...
    if (r) {
      ...
      if (a ? (t.width = this.maxWidth, t.height = qt(o) + l) : (t.height = this.maxHeight, t.width = qt(o) + l), s.display && this.ticks.length) {
        ...
        if (a) {
          const _ = s.mirror ? 0 : m * d.width + p * u.height;
          t.height = Math.min(this.maxHeight, t.height + _ + f);
        } else {
          const _ = s.mirror ? 0 : p * d.width + m * u.height;
  ...
  _computeLabelSizes(t, e, s) {
    ...
    let c = 0, h = 0, d, u, f, g, p, m, _, S, C, w, v;
    for (d = 0; d < e; d += l) {
      if (g = t[d].label, p = this._resolveTickFontOptions(d), n.font = m = p.string, _ = o[m] = o[m] || {
        data: {},
        gc: []
      }, S = p.lineHeight, C = w = 0, !H(g) && !j(g))
        C = Gi(n, _.data, _.gc, C, g), w = S;
      else if (j(g))
        for (u = 0, f = g.length; u < f; ++u)
          v = g[u], !H(v) && !j(v) && (C = Gi(n, _.data, _.gc, C, v), w += S);
      r.push(C), a.push(w), c = Math.max(C, c), h = Math.max(w, h);
    }
    Ya(o, e);
    const D = r.indexOf(c), O = a.indexOf(h), M = (P) => ({
      width: r[P] || 0,
      height: a[P] || 0
    });
    return {
  ...
  getPixelForDecimal(t) {
    ...
    return Ho(this._alignToPixels ? Dt(this.chart, e, 0) : e);
  }
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const s = e[t];
      return s.$context || (s.$context = qa(this.getContext(), t, s));
    }
    return this.$context || (this.$context = Ga(this.chart.getContext(), this));
  }
  _tickSize() {
  ...
  _computeGridLineItems(t) {
    const e = this.axis, s = this.chart, n = this.options, { grid: o, position: r, border: a } = n, l = o.offset, c = this.isHorizontal(), d = this.ticks.length + (l ? 1 : 0), u = qt(o), f = [], g = a.setContext(this.getContext()), p = g.display ? g.width : 0, m = p / 2, _ = function(A) {
      return Dt(s, A, p);
    };
    let S, C, w, v, D, O, M, P, I, x, b, F;
    if (r === "top")
      S = _(this.bottom), O = this.bottom - u, P = S - m, x = _(t.top) + m, F = t.bottom;
    else if (r === "bottom")
      S = _(this.top), x = t.top, F = _(t.bottom) - m, O = S + m, P = this.top + u;
    else if (r === "left")
      S = _(this.right), D = this.right - u, M = S - m, I = _(t.left) + m, b = t.right;
    else if (r === "right")
      S = _(this.left), I = t.left, b = _(t.right) - m, D = S + m, M = this.left + u;
    else if (e === "x") {
      if (r === "center")
        S = _((t.top + t.bottom) / 2 + 0.5);
      else if (z(r)) {
        const A = Object.keys(r)[0], B = r[A];
        S = _(this.chart.scales[A].getPixelForValue(B));
      }
      x = t.top, F = t.bottom, O = S + m, P = O + u;
    } else if (e === "y") {
      if (r === "center")
      ...
      D = S - m, M = D - u, I = t.left, b = t.right;
    }
    const R = L(n.ticks.maxTicksLimit, d), k = Math.max(1, Math.ceil(d / R));
    for (C = 0; C < d; C += k) {
      const A = this.getContext(C), B = o.setContext(A), nt = a.setContext(A), ht = B.lineWidth, dt = B.color, St = nt.dash || [], ut = nt.dashOffset, _t = B.tickWidth, Q = B.tickColor, $t = B.tickBorderDash || [], Mt = B.tickBorderDashOffset;
      w = Ua(this, C, l), w !== void 0 && (v = Dt(s, w, ht), c ? D = M = I = b = v : O = P = x = F = v, f.push({
        tx1: D,
        ty1: O,
        tx2: M,
        ty2: P,
  ...
  _computeLabelItems(t) {
    const e = this.axis, s = this.options, { position: n, ticks: o } = s, r = this.isHorizontal(), a = this.ticks, { align: l, crossAlign: c, padding: h, mirror: d } = o, u = qt(s.grid), f = u + h, g = d ? -h : f, p = -At(this.labelRotation), m = [];
    let _, S, C, w, v, D, O, M, P, I, x, b, F = "middle";
    if (n === "top")
      D = this.bottom - g, O = this._getXAxisLabelAlignment();
    else if (n === "bottom")
      D = this.top + g, O = this._getXAxisLabelAlignment();
    else if (n === "left") {
      ...
      if (n === "center")
        ...
        const k = Object.keys(n)[0], A = n[k];
        D = this.chart.scales[k].getPixelForValue(A) + f;
      }
      ...
      if (n === "center")
        ...
        const k = Object.keys(n)[0], A = n[k];
        v = this.chart.scales[k].getPixelForValue(A);
      }
    ...
    for (_ = 0, S = a.length; _ < S; ++_) {
      ...
      M = this.getPixelForTick(_) + o.labelOffset, P = this._resolveTickFontOptions(_), I = P.lineHeight, x = j(w) ? w.length : 1;
      const A = x / 2, B = k.color, nt = k.textStrokeColor, ht = k.textStrokeWidth;
      let dt = O;
      r ? (v = M, O === "inner" && (_ === S - 1 ? dt = this.options.reverse ? "left" : "right" : _ === 0 ? dt = this.options.reverse ? "right" : "left" : dt = "center"), n === "top" ? c === "near" || p !== 0 ? b = -x * I + I / 2 : c === "center" ? b = -R.highest.height / 2 - A * I + I : b = -R.highest.height + I / 2 : c === "near" || p !== 0 ? b = I / 2 : c === "center" ? b = R.highest.height / 2 - A * I : b = R.highest.height - x * I, d && (b *= -1), p !== 0 && !k.showLabelBackdrop && (v += I / 2 * Math.sin(p))) : (D = M, b = (1 - x) * I / 2);
      let St;
      if (k.showLabelBackdrop) {
        const ut = it(k.backdropPadding), _t = R.heights[_], Q = R.widths[_];
        let $t = b - ut.top, Mt = 0 - ut.left;
        switch (F) {
          case "middle":
            $t -= _t / 2;
            break;
  ...
  drawTitle() {
    ...
    e === "bottom" || e === "center" || z(e) ? (l += r.bottom, j(s.text) && (l += o.lineHeight * (s.text.length - 1))) : l += r.top;
    const { titleX: c, titleY: h, maxWidth: d, rotation: u } = Ka(this, l, e, a);
    de(t, s.text, 0, 0, o, {
      color: s.color,
      maxWidth: d,
      rotation: u,
...
class Me {
  ...
  register(t) {
    ...
    let s;
    Ja(e) && (s = this.register(e));
    const n = this.items, o = t.id, r = this.scope + "." + o;
    if (!o)
      throw new Error("class does not have id: " + t);
    return o in n || (n[o] = t, Qa(t, r, s), this.override && V.override(t.id, t.overrides)), r;
  }
  get(t) {
    return this.items[t];
  }
  unregister(t) {
    ...
    s in e && delete e[s], n && s in V[n] && (delete V[n][s], this.override && delete Ft[s]);
  }
}
function Qa(i, t, e) {
  ...
  V.set(t, s), i.defaultRoutes && Za(t, i.defaultRoutes), i.descriptors && V.describe(t, i.descriptors);
}
function Za(i, t) {
...
class tl {
  constructor() {
    this.controllers = new Me(re, "datasets", !0), this.elements = new Me(bt, "elements"), this.plugins = new Me(Object, "plugins"), this.scales = new Me(jt, "scales"), this._typedRegistries = [
      this.controllers,
      this.scales,
      this.elements
    ];
...
class el {
  ...
  _createDescriptors(t, e) {
    const s = t && t.config, n = L(s.options && s.options.plugins, {}), o = il(s);
...
function hl(i, t) {
  ...
  return Object.keys(s).forEach((r) => {
    ...
    const l = di(r, a, cl(r, i), V.scales[a.type]), c = al(l, n), h = e.scales || {};
    ...
    const a = r.type || i.type, l = r.indexAxis || hi(a, t), h = (Ft[a] || {}).scales || {};
    Object.keys(h).forEach((d) => {
      const u = rl(d, l), f = r[u + "AxisID"] || u;
...
function wn(i) {
  ...
  t.plugins = L(t.plugins, {}), t.scales = hl(i, t);
}
function kn(i) {
...
class ul {
  ...
  getOptionScopes(t, e, s) {
    ...
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => Xt(l, t, d))), h.forEach((d) => Xt(l, n, d)), h.forEach((d) => Xt(l, Ft[o] || {}, d)), h.forEach((d) => Xt(l, V, d)), h.forEach((d) => Xt(l, ai, d));
    });
...
const fl = (i) => z(i) && Object.getOwnPropertyNames(i).some((t) => kt(i[t]));
function gl(i, t) {
  const { isScriptable: e, isIndexable: s } = an(i);
  for (const n of t) {
    const o = e(n), r = s(n), a = (r || o) && i[n];
    if (o && (kt(a) || fl(a)) || r && j(a))
      return !0;
  }
  return !1;
}
...
let $e = (xt = class {
  ...
  constructor(t, e) {
    ...
    if (this.id = wo(), this.ctx = a, this.canvas = l, this.width = h, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new el(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = jo((d) => this.update(d), r.resizeDelay || 0), this._dataChanges = [], Le[this.id] = this, !a || !l) {
      console.error("Failed to create chart: can't acquire context from the given item");
      return;
    }
    gt.listen(this, "complete", Ss), gt.listen(this, "progress", bl), this._initialize(), this.attached && this.update();
  }
  get aspectRatio() {
  ...
  buildOrUpdateScales() {
    ...
    e && (o = o.concat(Object.keys(e).map((r) => {
      ...
      const a = r.options, l = a.id, c = di(l, a), h = L(a.type, r.dtype);
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
      ...
      if (r.type && r.type !== a && (this._destroyDatasetMeta(s), r = this.getDatasetMeta(s)), r.type = a, r.indexAxis = o.indexAxis || hi(a, this.options), r.order = o.order || 0, r.index = s, r.label = "" + o.label, r.visible = this.isDatasetVisible(s), r.controller)
        ...
        const l = lt.getController(a), { datasetElementType: c, dataElementType: h } = V.datasets[a];
        Object.assign(l, {
  ...
  render() {
    this.notifyPlugins("beforeRender", {
      cancelable: !0
    }) !== !1 && (gt.has(this) ? this.attached && !gt.running(this) && gt.start(this) : (this.draw(), Ss({
      chart: this
    })));
  }
  draw() {
  ...
  _handleEvent(t, e, s) {
    const { _active: n = [], options: o } = this, r = e, a = this._getActiveElements(t, n, s, r), l = Oo(t), c = xl(t, this._lastEvent, s, l);
...
}, T(xt, "defaults", V), T(xt, "instances", Le), T(xt, "overrides", Ft), T(xt, "registry", lt), T(xt, "version", pl), T(xt, "getChart", Ms), xt);
function Cs() {
  return E($e.instances, (i) => i._plugins.invalidate());
}
function Cn(i, t, e = t) {
...
function vl(i) {
  return i.stepped ? sr : i.tension || i.cubicInterpolationMode === "monotone" ? nr : yl;
}
function Dn(i, t, e = {}) {
...
function wl(i, t, e, s) {
  const { points: n, options: o } = t, { count: r, start: a, loop: l, ilen: c } = Dn(n, e, s), h = vl(o);
...
function kl(i, t, e, s) {
  ...
  let h = 0, d = 0, u, f, g, p, m, _;
  const S = (w) => (r + (c ? a - w : w)) % o, C = () => {
    p !== m && (i.lineTo(h, m), i.lineTo(h, p), i.lineTo(h, _));
  };
  for (l && (f = n[S(0)], i.moveTo(f.x, f.y)), u = 0; u <= a; ++u) {
    if (f = n[S(u)], f.skip)
      continue;
    const w = f.x, v = f.y, D = w | 0;
    D === g ? (v < p ? p = v : v > m && (m = v), h = (d * h + w) / ++d) : (C(), i.lineTo(w, v), g = D, d = 0, p = m = v), _ = v;
  }
  C();
}
function ui(i) {
...
function Sl(i) {
  return i.stepped ? Er : i.tension || i.cubicInterpolationMode === "monotone" ? Hr : Tt;
}
function Ml(i, t, e, s) {
  let n = t._path;
...
class Jt extends bt {
  ...
  get segments() {
    return this._segments || (this._segments = Yr(this, this.options.segment));
  }
  first() {
  ...
  interpolate(t, e) {
    const s = this.options, n = t[e], o = this.points, r = jr(this, {
      property: e,
      start: n,
      end: n
    });
...
class Ps extends bt {
  ...
  _fitCols(t, e, s, n) {
    ...
    return this.legendItems.forEach((m, _) => {
      const { itemWidth: S, itemHeight: C } = Tl(s, e, o, m, n);
      _ > 0 && f + C + 2 * a > h && (d += u + a, c.push({
        width: u,
        height: f
      }), g += u + a, p++, u = f = 0), l[_] = {
        left: g,
  ...
  adjustHitBoxes() {
    if (!this.options.display)
      return;
    const t = this._computeTitleHeight(), { legendHitBoxes: e, options: { align: s, labels: { padding: n }, rtl: o } } = this, r = Bt(o, this.left, this.width);
    if (this.isHorizontal()) {
  ...
  _draw() {
    const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this, { align: o, labels: r } = t, a = V.color, l = Bt(t.rtl, this.left, this.width), c = Y(r.font), { padding: h } = r, d = c.size, u = d / 2;
    let f;
    this.drawTitle(), n.textAlign = l.textAlign("left"), n.textBaseline = "middle", n.lineWidth = 0.5, n.font = c.string;
    const { boxWidth: g, boxHeight: p, itemHeight: m } = Os(r, d), _ = function(D, O, M) {
      if (isNaN(g) || g <= 0 || isNaN(p) || p < 0)
        return;
      n.save();
      const P = L(M.lineWidth, 1);
      if (n.fillStyle = L(M.fillStyle, a), n.lineCap = L(M.lineCap, "butt"), n.lineDashOffset = L(M.lineDashOffset, 0), n.lineJoin = L(M.lineJoin, "miter"), n.lineWidth = P, n.strokeStyle = L(M.strokeStyle, a), n.setLineDash(L(M.lineDash, [])), r.usePointStyle) {
        const I = {
          radius: p * Math.SQRT2 / 2,
          pointStyle: M.pointStyle,
          rotation: M.rotation,
          borderWidth: P
        }, x = l.xPlus(D, g / 2), b = O + u;
        on(n, I, x, b, r.pointStyleWidth && g);
      } else {
        const I = O + Math.max((d - p) / 2, 0), x = l.leftForLtr(D, g), b = oe(M.borderRadius);
        n.beginPath(), Object.values(b).some((F) => F !== 0) ? ci(n, {
          x,
          y: I,
          w: g,
          h: p,
          radius: b
        }) : n.rect(x, I, g, p), n.fill(), P !== 0 && n.stroke();
      }
      n.restore();
    }, S = function(D, O, M) {
      de(n, M.text, D, O + m / 2, c, {
        strikethrough: M.hidden,
        textAlign: l.textAlign(M.textAlign)
      });
    }, C = this.isHorizontal(), w = this._computeTitleHeight();
    C ? f = {
      ...
      x: this.left + h,
      y: U(o, this.top + w + h, this.bottom - e[0].height),
      line: 0
    }, un(this.ctx, t.textDirection);
    const v = m + h;
    this.legendItems.forEach((D, O) => {
      n.strokeStyle = D.fontColor, n.fillStyle = D.fontColor;
      const M = n.measureText(D.text).width, P = l.textAlign(D.textAlign || (D.textAlign = r.textAlign)), I = g + u + M;
      let x = f.x, b = f.y;
      l.setWidth(this.width), C ? O > 0 && x + I + h > this.right && (b = f.y += v, f.line++, x = f.x = U(o, this.left + h, this.right - s[f.line])) : O > 0 && b + v > this.bottom && (x = f.x = x + e[f.line].width + h, f.line++, b = f.y = U(o, this.top + w + h, this.bottom - e[f.line].height));
      const F = l.x(x);
      if (_(F, b, D), x = $o(P, x + g + u, C ? x + I : this.right, t.rtl), S(l.x(x), b, D), C)
        f.x += I + h;
  ...
  drawTitle() {
    ...
    if (!e.display)
      return;
    const o = Bt(t.rtl, this.left, this.width), r = this.ctx, a = e.position, l = s.size / 2, c = n.top + l;
...
function Tl(i, t, e, s, n) {
  const o = Al(s, i, t, e), r = Ll(n, s, t.lineHeight);
  return {
    itemWidth: o,
    itemHeight: r
  };
...
class Pn extends bt {
  ...
  _drawArgs(t) {
    ...
    let l = 0, c, h, d;
    return this.isHorizontal() ? (h = U(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = U(a, n, e), l = $ * -0.5) : (h = o - t, d = U(a, e, n), l = $ * 0.5), c = n - e), {
      titleX: h,
      titleY: d,
      maxWidth: c,
      rotation: l
...
function Ts(i, t) {
  const e = i.chart.ctx, { body: s, footer: n, title: o } = i, { boxWidth: r, boxHeight: a } = t, l = Y(t.bodyFont), c = Y(t.titleFont), h = Y(t.footerFont), d = o.length, u = n.length, f = s.length, g = it(t.padding);
  let p = g.height, m = 0, _ = s.reduce((w, v) => w + v.before.length + v.lines.length + v.after.length, 0);
  if (_ += i.beforeBody.length + i.afterBody.length, d && (p += d * c.lineHeight + (d - 1) * t.titleSpacing + t.titleMarginBottom), _) {
    ...
    p += f * w + (_ - f) * l.lineHeight + (_ - 1) * t.bodySpacing;
  }
  u && (p += t.footerMarginTop + u * h.lineHeight + (u - 1) * t.footerSpacing);
  let S = 0;
  const C = function(w) {
    m = Math.max(m, e.measureText(w).width + S);
  };
  return e.save(), e.font = c.string, E(i.title, C), e.font = l.string, E(i.beforeBody.concat(i.afterBody), C), S = t.displayColors ? r + 2 + t.boxPadding : 0, E(s, (w) => {
    E(w.before, C), E(w.lines, C), E(w.after, C);
  }), S = 0, e.font = h.string, E(i.footer, C), e.restore(), m += g.width, {
    width: m,
    height: p
  };
}
...
function Nl(i, t, e, s) {
  ...
  let c = "center";
  return s === "center" ? c = n <= (a + l) / 2 ? "left" : "right" : n <= o / 2 ? c = "left" : n >= r - o / 2 && (c = "right"), Bl(c, i, t, e) && (c = "center"), c;
}
function As(i, t, e) {
...
class fi extends bt {
  ...
  getTitle(t, e) {
    ...
    let a = [];
    return a = at(a, pt(n)), a = at(a, pt(o)), a = at(a, pt(r)), a;
  }
  getBeforeBody(t, e) {
  ...
  getBody(t, e) {
    ...
    return E(t, (o) => {
      ...
      at(r.before, pt(X(a, "beforeLabel", this, o))), at(r.lines, X(a, "label", this, o)), at(r.after, pt(X(a, "afterLabel", this, o))), n.push(r);
    }), n;
  }
  getAfterBody(t, e) {
  ...
  getCaretPosition(t, e, s) {
    const { xAlign: n, yAlign: o } = this, { caretSize: r, cornerRadius: a } = s, { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = oe(a), { x: u, y: f } = t, { width: g, height: p } = e;
    let m, _, S, C, w, v;
    return o === "center" ? (w = f + p / 2, n === "left" ? (m = u, _ = m - r, C = w + r, v = w - r) : (m = u + g, _ = m + r, C = w - r, v = w + r), S = m) : (n === "left" ? _ = u + Math.max(l, h) + r : n === "right" ? _ = u + g - Math.max(c, d) - r : _ = this.caretX, o === "top" ? (C = f, w = C - r, m = _ - r, S = _ + r) : (C = f + p, w = C + r, m = _ + r, S = _ - r), v = C), {
      x1: m,
      x2: _,
      x3: S,
      y1: C,
  ...
  _drawColorBox(t, e, s, n, o) {
    const r = this.labelColors[s], a = this.labelPointStyles[s], { boxHeight: l, boxWidth: c } = o, h = Y(o.bodyFont), d = De(this, "left", o), u = n.x(d), f = l < h.lineHeight ? (h.lineHeight - l) / 2 : 0, g = e.y + f;
    if (o.usePointStyle) {
      const p = {
        ...
        rotation: a.rotation,
        borderWidth: 1
      }, m = n.leftForLtr(u, c) + c / 2, _ = g + l / 2;
      t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, li(t, p, m, _), t.strokeStyle = r.borderColor, t.fillStyle = r.backgroundColor, li(t, p, m, _);
    } else {
      ...
      const p = n.leftForLtr(u, c), m = n.leftForLtr(n.xPlus(u, 1), c - 2), _ = oe(r.borderRadius);
      Object.values(_).some((S) => S !== 0) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, ci(t, {
        x: p,
        y: g,
        w: c,
        h: l,
  ...
  drawBody(t, e, s) {
    ...
    const g = Bt(s.rtl, this.x, this.width), p = function(M) {
      e.fillText(M, g.x(t.x + f), t.y + u / 2), t.y += u + o;
    }, m = g.textAlign(r);
    let _, S, C, w, v, D, O;
    for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = De(this, m, s), e.fillStyle = s.bodyColor, E(this.beforeBody, p), f = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, w = 0, D = n.length; w < D; ++w) {
      for (_ = n[w], S = this.labelTextColors[w], e.fillStyle = S, E(_.before, p), C = _.lines, a && C.length && (this._drawColorBox(e, t, w, g, s), u = Math.max(d.lineHeight, l)), v = 0, O = C.length; v < O; ++v)
        p(C[v]), u = d.lineHeight;
      E(_.after, p);
    }
  ...
  drawFooter(t, e, s) {
    ...
    let r, a;
    if (o) {
      const l = Bt(s.rtl, this.x, this.width);
  ...
  drawBackground(t, e, s, n) {
    const { xAlign: o, yAlign: r } = this, { x: a, y: l } = t, { width: c, height: h } = s, { topLeft: d, topRight: u, bottomLeft: f, bottomRight: g } = oe(n.cornerRadius);
...
class gi extends jt {
  ...
  parse(t, e) {
    if (H(t))
      return null;
    const s = this.getLabels();
    return e = isFinite(e) && s[e] === t ? e : Yl(s, t, L(e, t), this._addedLabels), Gl(e, s.length - 1);
  }
  determineDataLimits() {
...
function ql(i, t) {
  const e = [], { bounds: n, step: o, min: r, max: a, precision: l, count: c, maxTicks: h, maxDigits: d, includeBounds: u } = i, f = o || 1, g = h - 1, { min: p, max: m } = t, _ = !H(r), S = !H(a), C = !H(c), w = (m - p) / (d + 1);
  let v = Ni((m - p) / g / f) * f, D, O, M, P;
  if (v < 1e-14 && !_ && !S)
    return [
      {
        value: p
  ...
  P = Math.ceil(m / v) - Math.floor(p / v), P > g && (v = Ni(P * v / g / f) * f), H(l) || (D = Math.pow(10, l), v = Math.ceil(v * D) / D), n === "ticks" ? (O = Math.floor(p / v) * v, M = Math.ceil(m / v) * v) : (O = p, M = m), _ && S && o && Io((a - r) / o, v / 1e3) ? (P = Math.round(Math.min((a - r) / v, h)), v = (a - r) / P, O = r, M = a) : C ? (O = _ ? r : O, M = S ? a : M, P = c - 1, v = (M - O) / P) : (P = (M - O) / v, ie(P, Math.round(P), v / 1e3) ? P = Math.round(P) : P = Math.ceil(P));
  const I = Math.max(Wi(v), Wi(O));
  D = Math.pow(10, H(l) ? I : l), O = Math.round(O * D) / D, M = Math.round(M * D) / D;
  let x = 0;
  for (_ && (u && O !== r ? (e.push({
    value: r
  }), O < r && x++, ie(Math.round((O + x * v) * D) / D, r, Rs(r, w, i)) && x++) : O < r && x++); x < P; ++x) {
    const b = Math.round((O + x * v) * D) / D;
    if (S && b > a)
      break;
    e.push({
      value: b
  ...
  return S && u && M !== a ? e.length && ie(e[e.length - 1].value, a, Rs(a, w, i)) ? e[e.length - 1].value = a : e.push({
    value: a
  }) : (!S || M === a) && e.push({
    value: M
  }), e;
...
class Xl extends jt {
  ...
  buildTicks() {
    ...
    }, o = this._range || this, r = ql(n, o);
    return t.bounds === "ticks" && Fo(r, this, "value"), t.reverse ? (r.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), r;
  }
  configure() {
    const t = this.ticks;
...
function Bs(i, t, e, s) {
  ...
  for (let o = K.indexOf(i); o < n - 1; ++o) {
    const r = Ue[K[o]], a = r.steps ? r.steps : Number.MAX_SAFE_INTEGER;
...
class We extends jt {
  ...
  init(t, e = {}) {
    const s = t.time || (t.time = {}), n = this._adapter = new da._date(t.adapters.date);
  ...
  buildTicks() {
    ...
    const o = this.min, r = this.max, a = No(n, o, r);
    return this._unit = e.unit || (s.autoSkip ? Bs(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : Kl(this, a.length, e.minUnit, this.min, this.max)), this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : Ql(this._unit), this.initOffsets(n), t.reverse && a.reverse(), Ws(this, a, this._majorUnit);
  }
  afterAutoSkip() {
  ...
  _generate() {
    const t = this._adapter, e = this.min, s = this.max, n = this.options, o = n.time, r = o.unit || Bs(o.minUnit, e, s, this._getLabelCapacity(e)), a = L(n.ticks.stepSize, 1), l = r === "week" ? o.isoWeekday : !1, c = ce(l) || l === !0, h = {};
    let d = e, u, f;
    ...
    for (u = d, f = 0; u < s; u = +t.add(u, a, r), f++)
      Ns(h, u, g);
    return (u === s || n.bounds === "ticks" || f === 1) && Ns(h, u, g), Object.keys(h).sort(Es).map((p) => +p);
  }
  getLabelForValue(t) {
...
const oc = mi({
  ...
  setup(i, t) {
    ...
    const r = () => {
      if (!n.value) return;
      const { type: c, data: h, options: d, plugins: u, datasetIdKey: f } = i, g = nc(h, f), p = ic(g, h);
    ...
    return Us(r), Rn(a), En([
      ...
      if (u) {
        const _ = Ht(u.labels), S = Ht(g.labels), C = Ht(u.datasets), w = Ht(g.datasets);
        _ !== S && (Ln(p.config.data, _), m = !0), C && C !== w && (In(p.config.data, C, i.datasetIdKey), m = !0);
      }
      m && Hn(() => {
        l(p);
      });
...
const ac = /* @__PURE__ */ rc("line", Te), lc = { class: "dashboard-container" }, cc = {
  key: 0,
  class: "loading"
}, hc = {
  key: 1,
  ...
  setup(i, { emit: t }) {
    ...
    const e = t, s = Zn(1e4), n = Li({}), o = Li({}), r = Pe(null), a = Pe(null), l = Pe(null);
    function c() {
      return new URLSearchParams(window.location.search).get("all_cts_clientId");
    }
    function h(x) {
      if (!x) return null;
      const b = x.match(/Client\s*(\d+)/i);
      return b ? parseInt(b[1]) : null;
    }
    Us(() => {
      l.value = c(), window.addEventListener("popstate", () => {
        l.value = c();
      });
    });
    const d = Xn(), u = ni({
      queryKey: ot(() => ["nlvHistory", r.value]),
      queryFn: async () => {
        if (!r.value) return [];
        console.log("🔍 Querying NLV history for account:", r.value);
        const { data: x, error: b } = await d.schema("hf").from("netliquidation").select("internal_account_id, fetched_at, nlv").eq("internal_account_id", r.value).gte("fetched_at", new Date(Date.now() - 30 * 24 * 60 * 60 * 1e3).toISOString()).order("fetched_at", { ascending: !0 });
        if (b)
      ...
      staleTime: 6e4,
      enabled: ot(() => !!r.value && a.value === "nlv")
    }), f = ni({
      queryKey: ot(() => ["maintenanceHistory", r.value]),
      queryFn: async () => {
        if (!r.value) return [];
        console.log("🔍 Querying Maintenance Margin history for account:", r.value);
        const { data: x, error: b } = await d.schema("hf").from("maintenance_margin").select("internal_account_id, fetched_at, maintenance").eq("internal_account_id", r.value).gte("fetched_at", new Date(Date.now() - 30 * 24 * 60 * 60 * 1e3).toISOString()).order("fetched_at", { ascending: !0 });
        if (b)
    ...
    function p(x, b) {
      console.log("🔄 Toggle graph called:", { accountId: x, type: b }), o[x] || (o[x] = { nlv: !1, mm: !1 });
      const F = o[x][b];
      Object.keys(o).forEach((R) => {
        const k = parseInt(R);
        o[k] && (o[k].nlv = !1, o[k].mm = !1);
      }), o[x][b] = !F, o[x][b] ? (console.log("📊 Setting selected account for history:", x, "type:", b), r.value = x, a.value = b) : (console.log("❌ Clearing selected account for history"), r.value = null, a.value = null), console.log("📈 Graph visibility state:", o), console.log("🎯 Selected account for history:", r.value, "type:", a.value);
    }
    const m = ot(() => a.value === "nlv" ? u : a.value === "mm" ? f : null), _ = ot(() => {
      var A;
      const x = m.value;
      if (!((A = x == null ? void 0 : x.data.value) != null && A.length)) return null;
      const b = x.data.value, F = b.map((B) => new Date(B.fetched_at).toLocaleDateString()), R = a.value === "nlv", k = b.map((B) => R ? B.nlv : B.maintenance);
      return {
        labels: F,
        datasets: [
          {
            label: R ? "Net Liquidation Value" : "Maintenance Margin",
            data: k,
            borderColor: R ? "#3b82f6" : "#f59e0b",
            backgroundColor: R ? "rgba(59, 130, 246, 0.1)" : "rgba(245, 158, 11, 0.1)",
            borderWidth: 3,
            pointRadius: 4,
            pointHoverRadius: 6,
            tension: 0.1,
    ...
    function C(x, b, F) {
      const R = 1 - F, k = 1 - b, B = 1 - R * k;
      return x / B;
    }
    const w = ot(() => s.data.value ? s.data.value.map((x) => {
      const b = C(x.nlv_val, 0.3, 0.15), F = C(x.nlv_val, 0.3, 0.1), R = b * 30 / 100, k = F * 30 / 100, A = R - x.maintenance_val, B = k - x.maintenance_val, nt = A * 100 / 30, ht = B * 100 / 30;
      return {
        ...x,
        maxGmvNlvSide: b,
        maxGmvMaintenanceSide: F,
        mkNlvSide: R,
        mkMaintenanceSide: k,
        maintnanceMarginHeadroomNlvSide: A,
        maintnanceMarginHeadroomMaintenanceSide: B,
        addlGmvAllowedNlvSide: nt,
        addlGmvAllowedMaintenanceSide: ht
      };
    }) : []), v = ot(() => {
      if (!l.value || !w.value)
        return w.value;
      ...
      if (x === null)
        return w.value;
      const b = x - 1;
      return b >= 0 && b < w.value.length ? [w.value[b]] : w.value;
    }), D = ot(() => {
      if (!w.value) return null;
      const x = w.value.reduce((k, A) => k + (A.nlv_val || 0), 0), b = w.value.reduce((k, A) => k + (A.maintenance_val || 0), 0), F = w.value.reduce((k, A) => k + (A.addlGmvAllowedNlvSide || 0), 0), R = w.value.reduce((k, A) => k + (A.addlGmvAllowedMaintenanceSide || 0), 0);
      return {
        totalNlv: x,
        totalMaintenance: b,
        totalAddlGmvToStopReducing: F,
    ...
    function P(x) {
      var k;
      const F = (((k = w.value) == null ? void 0 : k.findIndex((A) => A.nlv_internal_account_id === x)) ?? -1) + 1, R = new URL(window.location.href);
      R.searchParams.set("all_cts_clientId", "Client " + F.toString()), window.history.replaceState({}, "", R.toString()), l.value = "Client " + F.toString(), M == null || M.emit("client-id-changed", {
        clientId: "Client " + F.toString(),
        accountId: x
      });
    }
    function I() {
      const x = new URL(window.location.href);
      x.searchParams.delete("all_cts_clientId"), window.history.replaceState({}, "", x.toString()), l.value = null, M == null || M.emit("client-id-changed", {
        clientId: null,
        accountId: null
      });
    }
    return Nn(() => {
      ...
      var R;
      const F = Wn("router-link");
      return G(), q("div", lc, [
        Rt(s).isLoading.value ? (G(), q("div", cc, [...b[1] || (b[1] = [
          y("div", { class: "loading-spinner" }, null, -1),
          y("p", null, "Loading the latest metrics...", -1)
        ])])) : Rt(s).isError.value ? (G(), q("div", hc, [
          b[2] || (b[2] = y("h2", null, "Error Loading Data", -1)),
          b[3] || (b[3] = y("p", null, "An error occurred while fetching the metrics:", -1)),
          y("pre", null, N(Rt(s).error.value), 1)
        ])) : Rt(s).isSuccess.value ? (G(), q("div", dc, [
          y("div", uc, [
            y("div", fc, [
              y("h2", null, [
                i.showHeaderLink ? (G(), Vn(F, {
                  key: 0,
                  to: "/summary",
                  class: "summary-link"
                }, {
            ...
            D.value ? (G(), q("div", pc, [
              y("div", {
                class: "row-header",
                onClick: I
              }, "All Accounts (" + N(((R = Rt(s).data.value) == null ? void 0 : R.length) || 0) + ")", 1),
              y("div", mc, [
                y("div", bc, [
                  b[5] || (b[5] = y("div", { class: "metric-label" }, "Net liquidation value", -1)),
                  y("div", _c, N(g(D.value.totalNlv)), 1),
                  b[6] || (b[6] = y("div", { class: "metric-label" }, "Add'l GMV to stop-reducing cap", -1)),
                  y("div", xc, N(g(D.value.totalAddlGmvToStopReducing)), 1)
                ]),
                y("div", yc, [
                  b[7] || (b[7] = y("div", { class: "metric-label" }, "Maintenance margin", -1)),
                  y("div", vc, N(g(D.value.totalMaintenance)), 1),
                  b[8] || (b[8] = y("div", { class: "metric-label" }, "Add'l GMV to start-reducing cap", -1)),
                  y("div", wc, N(g(D.value.totalAddlGmvToStartReducing)), 1)
                ])
              ])
            ])) : ge("", !0),
            (G(!0), q(Un, null, Yn(v.value, (k, A) => {
              var B, nt, ht, dt, St, ut, _t;
              return G(), q("div", {
                ...
                y("div", kc, [
                  y("div", {
                    class: "row-header",
                    onClick: (Q) => P(k.nlv_internal_account_id)
                  }, " Client" + N(((B = w.value) == null ? void 0 : B.findIndex((Q) => Q.nlv_internal_account_id === k.nlv_internal_account_id)) + 1), 9, Sc),
                  y("button", {
                    ...
                    onClick: (Q) => O(k.nlv_id)
                  }, N(k.addlGmvAllowedNlvSide < 0 && k.addlGmvAllowedMaintenanceSide < 0 ? "Stage 2 exhausted" : k.addlGmvAllowedNlvSide < 0 ? "Stage 1 exhausted" : "OK"), 11, Mc)
                ]),
                y("div", Cc, [
                  y("div", Dc, [
                    y("div", Oc, [
                      b[10] || (b[10] = y("span", { class: "metric-label" }, "NLV", -1)),
                      y("button", {
                        class: Ye(["graph-icon", { active: (nt = o[k.nlv_internal_accountId]) == null ? void 0 : nt.nlv }]),
                        onClick: (Q) => p(k.nlv_internal_account_id, "nlv")
                      }, [...b[9] || (b[9] = [
                        y("svg", {
                          width: "16",
                          height: "16",
                          ...
                          y("path", { d: "M3 13h4v8H3v-8zm6-10h4v18H9V3zm6 6h4v12h-4V9z" })
                        ], -1)
                      ])], 10, Pc)
                    ]),
                    y("div", Tc, N(g(k.nlv_val)), 1),
                    b[11] || (b[11] = y("div", { class: "metric-label" }, "Add'l GMV to stop-reducing cap", -1)),
                    y("div", Ac, N(g(k.addlGmvAllowedNlvSide)), 1)
                  ]),
                  y("div", Lc, [
                    y("div", Ic, [
                      b[13] || (b[13] = y("span", { class: "metric-label" }, "Maintenance margin", -1)),
                      y("button", {
                        class: Ye(["graph-icon", { active: (ht = o[k.nlv_internal_accountId]) == null ? void 0 : ht.mm }]),
                        onClick: (Q) => p(k.nlv_internal_account_id, "mm")
                      }, [...b[12] || (b[12] = [
                        y("svg", {
                          width: "16",
                          height: "16",
                    ...
                    y("div", zc, N(g(k.maintenance_val)), 1),
                    b[14] || (b[14] = y("div", { class: "metric-label" }, "Add'l GMV to start-reducing cap", -1)),
                    y("div", Rc, N(g(k.addlGmvAllowedMaintenanceSide)), 1)
                  ])
                ]),
                (dt = o[k.nlv_internal_account_id]) != null && dt.nlv || (St = o[k.nlv_internal_account_id]) != null && St.mm ? (G(), q("div", Ec, [
                  (ut = m.value) != null && ut.isLoading.value ? (G(), q("div", Hc, " Loading " + N(a.value === "nlv" ? "NLV" : "Maintenance Margin") + " historical data... ", 1)) : (_t = m.value) != null && _t.isError.value ? (G(), q("div", Bc, " Error loading " + N(a.value === "nlv" ? "NLV" : "Maintenance Margin") + " historical data: " + N(m.value.error.value), 1)) : _.value ? (G(), q("div", Nc, [
                    y("h4", null, N(a.value === "nlv" ? "NLV" : "Maintenance Margin") + " History ", 1),
                    y("div", Wc, [
                      Gn(Rt(ac), {
                        data: _.value,
                        options: S.value,
                  ...
                  ])) : (G(), q("div", Vc, " No " + N(a.value === "nlv" ? "NLV" : "Maintenance Margin") + " historical data available ", 1))
                ])) : ge("", !0),
                n[k.nlv_id] ? (G(), q("div", jc, [
                  b[25] || (b[25] = y("div", { class: "breakdown-header" }, [
                    y("div", null, "Calculation breakdown:"),
                    y("div", null, "Assumptions: maintenance margin (m) = 30%")
                  ], -1)),
                  y("div", $c, [
                    y("div", Uc, [
                      b[19] || (b[19] = y("div", { class: "stage-header" }, "Stage-1 (drop d = 15%)", -1)),
                      y("div", Yc, [
                        b[15] || (b[15] = y("div", { class: "item-label" }, "Max GMV that survives stop-adding threshold", -1)),
                        y("div", Gc, [
                          y("span", qc, "Gmax = NLV / [ 1 - (1 - d) x (1 - m) ] = " + N(g(k.maxGmvNlvSide)), 1)
                        ])
                      ]),
                      y("div", Xc, [
                        b[16] || (b[16] = y("div", { class: "item-label" }, "Max Maintenance margin (Before drop) to survive drop", -1)),
                        y("div", Kc, [
                          y("span", Qc, "Mk = Gmax x m = " + N(g(k.mkNlvSide)), 1)
                        ])
                      ]),
                      y("div", Zc, [
                        b[17] || (b[17] = y("div", { class: "item-label" }, "Maintenance margin headroom", -1)),
                        y("div", Jc, [
                          y("span", th, "Mk - M = " + N(g(k.maintnanceMarginHeadroomNlvSide)), 1)
                        ])
                      ]),
                      y("div", eh, [
                        b[18] || (b[18] = y("div", { class: "item-label" }, "Add'l GMV allowed", -1)),
                        y("div", ih, [
                          y("span", sh, "(Mk - M) / m = " + N(g(k.addlGmvAllowedNlvSide)), 1)
                        ])
                      ])
                    ]),
                    y("div", nh, [
                      b[24] || (b[24] = y("div", { class: "stage-header" }, "Stage-2 (drop d = 10%)", -1)),
                      y("div", oh, [
                        b[20] || (b[20] = y("div", { class: "item-label" }, "Max GMV that survives start-reducing threshold", -1)),
                        y("div", rh, [
                          y("span", ah, "Gmax = NLV / [ 1 - (1 - d) x (1 - m) ] = " + N(g(k.maxGmvMaintenanceSide)), 1)
                        ])
                      ]),
                      y("div", lh, [
                        b[21] || (b[21] = y("div", { class: "item-label" }, "Max Maintenance margin (Before drop) to survive drop", -1)),
                        y("div", ch, [
                          y("span", hh, "Mk = Gmax x m = " + N(g(k.mkMaintenanceSide)), 1)
                        ])
                      ]),
                      y("div", dh, [
                        b[22] || (b[22] = y("div", { class: "item-label" }, "Maintenance margin headroom", -1)),
                        y("div", uh, [
                          y("span", fh, "Mk - M = " + N(g(k.maintnanceMarginHeadroomMaintenanceSide)), 1)
                        ])
                      ]),
                      y("div", gh, [
                        b[23] || (b[23] = y("div", { class: "item-label" }, "Add'l GMV allowed", -1)),
                        y("div", ph, [
                          y("span", mh, "(Mk - M) / m = " + N(g(k.addlGmvAllowedMaintenanceSide)), 1)
                        ])
                      ])
                    ])
                  ])
  ...
  for (const [s, n] of t)
    e[s] = n;
  return e;
}, Sh = /* @__PURE__ */ _h(bh, [["__scopeId", "data-v-90d77c84"]]);
export {
  Sh as Summary,
  Sh as default
};
